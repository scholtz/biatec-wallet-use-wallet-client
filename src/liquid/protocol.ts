/**
 * Biatec Liquid Auth wire protocol — the dApp ⇄ wallet message layer that runs over the
 ...
 *
 * The full specification lives in docs/LIQUID_AUTH_PROTOCOL.md. The Biatec Wallet keeps a
 * mirror of this module (src/scripts/liquid/protocol.ts) — keep them in sync.
 */
