<script lang="ts">
   ...
   * already applied any stored choice before Svelte mounted (no flash on reload); this
   * component just renders the button and keeps `<html data-theme>` (and localStorage) in sync
   * with it.
   *
